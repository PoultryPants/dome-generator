...
4. **Corner Stairs Use:** Choose how corner stairs are placed for different block arrangements. Modes:
   ...
   - **All:** Uses corner stairs anywhere, even if it wouldn't be possible to place them there normally
5. **Ensure Symmetry:** Toggle this to force symmetric block placement.
6. **Preview:** The isometric canvas updates live as you change settings.

All controls are at the top. The canvas below shows a Minecraft-style preview of your dome. I am thinking of adding export options in the future as well.
